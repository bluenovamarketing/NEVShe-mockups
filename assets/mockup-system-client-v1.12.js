(() => {
  ...
  function renderConversion(c) {
    ...
    return `${pageHero(c)}${openingContent}<section class="section"><div class="container">${sectionHeading('Why participate','Learn, connect, and support the statewide community.','NEVShe participation is centered on professional education, statewide relationships, and stronger healthcare environments. Final membership or sponsorship terms will be published after chapter confirmation.')}${featureCards(c.cards)}</div></section>
      ${c.supportImage ? visualStory(c) : ''}

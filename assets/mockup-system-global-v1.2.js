(() => {
  ...
  function templateContent(slug) {
    ...
    if (slug === 'global-footer') return `<div class="preview-frame"><div class="preview-caption"><span>Sitewide footer</span><span>Production-ready link structure</span></div><div class="mini-footer"><div><strong>NEVShe</strong><p>Statewide healthcare facilities community.</p></div><div><b>Explore</b><p>About<br>Board<br>Events<br>News</p></div><div><b>Participate</b><p>Education<br>Membership<br>Sponsorship<br>Resources</p></div><div><b>Organization</b><p>Contact<br>Sitemap<br>Privacy<br>Terms<br>Accessibility</p></div></div></div><div class="notice" style="margin-top:28px">The notification-list CTA uses the confirmed Constant Contact destination. The Sitemap route is reserved for launch; final legal wording remains pending.</div>`;

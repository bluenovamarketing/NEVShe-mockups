(() => {
  ...
  const pageConfigs = {
    ...
    'about-nevshe': {
      ...
      cta: ['Learn about membership', '../membership-v1.2/'], secondary: ['Meet the board', '../board-of-directors-v1.2/'],
      sections: [
    ...
    'board-of-directors': {
      ...
      cta: ['Contact NEVShe', '../contact-v1.2/'],
    ...
    'sponsorship': {
      ...
      cta: ['Become a Sponsor', joinUrl], secondary: ['Ask a question', '../contact-v1.2/'],
  ...
  const local = (slug) => `${root}pages/${slug}-v1.2/`;

(() => {
  ...
  function renderHub() {
    ...
    const motionApproved = new Set(['home', 'about-nevshe', 'board-of-directors', 'events', 'education', 'membership', 'member-directory', 'sponsorship', 'sponsor-directory', 'resources', 'news', 'contact']);

(() => {
  ...
  const pageConfigs = {
    ...
    'about-nevshe': {
      ...
      editorialImage: 'v2:about-statewide-campus-v2.png',
  ...
  function renderHub() {
    ...
    const motionApproved = new Set(['home', 'board-of-directors', 'events', 'membership']);

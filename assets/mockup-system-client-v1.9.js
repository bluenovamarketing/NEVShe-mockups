(() => {
  ...
  const currentVersions = {
    'home': 'v1.9',
    'about-nevshe': 'v1.8',
    'board-of-directors': 'v1.8',
    'events': 'v1.6',
    'education': 'v1.7',
    'membership': 'v1.6',
    'member-directory': 'v1.8',
    'sponsorship': 'v1.9',
    'sponsor-directory': 'v1.8',
    'resources': 'v1.7',
    'news': 'v1.8',
    'contact': 'v1.7',
    'privacy-policy': 'v1.3',
  ...
  const pagePurpose = {
    'home': {
      ...
      title: 'Understand NEVShe, find what matters, and choose a next step.',
      intro: 'The homepage introduces the statewide chapter and helps facility professionals, healthcare leaders, and industry partners move quickly toward the information or action they need.',
      sections: [
        ['A clear introduction to the chapter', 'NEVShe brings together the people whose planning, technical knowledge, leadership, maintenance, and day-to-day decisions shape healthcare facilities throughout Nevada. The homepage explains that shared purpose before asking anyone to join, register, or explore. It gives first-time visitors enough context to understand why the organization exists and how education, professional development, and networking support the people behind safe, efficient, innovative healthcare environments. Returning visitors can use the same page as a quick route to current programs, resources, news, membership information, and chapter contacts.'],
        ['Built around the needs of different visitors', 'A facility manager may arrive looking for practical education. An engineer or technician may want technical resources and peers who understand complex systems. A healthcare leader may be looking for professional development or a statewide connection. An industry partner may want to understand the community before exploring sponsorship. The homepage does not force those visitors through the same path. It introduces the chapter’s audiences and then connects each person to the most relevant page, while keeping important actions such as joining, viewing events, and receiving notifications easy to find.'],
        ['A living overview, not a static brochure', 'As NEVShe confirms programs and materials, the homepage can surface the next event, recent education, approved resources, chapter news, and sponsor recognition without duplicating every detail. Each feature leads to a page designed for deeper information. This keeps the homepage useful and current while allowing staff to update structured content in WordPress rather than redesigning the page. The result is a welcoming front door that communicates statewide reach, professional credibility, and practical value, then helps visitors continue with confidence.'],
        ['What a visitor should understand before leaving', 'A successful visit should leave someone with three clear ideas: NEVShe serves the professionals and partners responsible for healthcare facilities; the chapter supports education, development, and statewide professional relationships; and the site provides direct ways to learn, participate, or stay informed. The homepage reinforces those ideas through real pathways rather than broad promotional language. Visitors who are not ready to join still leave knowing where to find programs, resources, leadership, member organizations, sponsors, and contact information when they need them.']
      ]
    },
    'about-nevshe': {
      eyebrow: 'Why NEVShe exists',
      title: 'A fuller picture of the chapter’s purpose and statewide role.',
      intro: 'This page explains the mission behind the organization, the people it serves, and the practical value of bringing Nevada’s healthcare facilities community together.',
      sections: [
        ['A professional home for the work behind care', 'Healthcare depends on more than the services delivered at the bedside. It also depends on the professionals who plan, operate, maintain, improve, and protect the buildings and systems where care takes place. NEVShe gives those professionals a focused statewide community. Its purpose is to advance healthcare facility managers, engineers, and technicians through targeted education, professional development, and networking. The chapter creates a place where practical knowledge and professional relationships can grow together instead of remaining isolated within individual facilities, companies, disciplines, or regions.'],
        ['Statewide connection with practical value', 'Nevada includes large urban healthcare campuses, smaller communities, rural facilities, and organizations that support them across considerable distance. A statewide chapter helps people share experience across those different settings. Members and partners can learn how others approach operational challenges, discover useful resources, meet professionals with complementary expertise, and stay connected to chapter programs. That exchange does not replace each facility’s policies, leadership, or technical responsibilities. It strengthens the professional network around them by making relevant education and peer connection easier to find.'],
        ['Mission translated into action', 'The chapter’s mission becomes visible through education, events, resources, leadership, membership, and opportunities for industry participation. Each area supports the same larger purpose: helping professionals build knowledge and relationships that contribute to safe, efficient, innovative healthcare environments. This page gives visitors the context they need before exploring those individual programs. It also provides a foundation for NEVShe’s future history, governance materials, and chapter milestones as confirmed information becomes available, while keeping the current message centered on service to Nevada’s healthcare facilities community.'],
        ['A foundation for future chapter information', 'NEVShe can expand this page with an approved founding story, chapter timeline, ASHE relationship details, governance documents, and milestones when the organization supplies them. Those additions should deepen the public understanding of the chapter without burying its present-day purpose. The permanent structure keeps mission, audiences, statewide reach, and participation visible first, then gives historical and governance information a clear place to live. This creates an About page that remains useful now and can grow responsibly as authoritative content becomes available.']
      ]
    },
    'board-of-directors': {
      eyebrow: 'Leadership and stewardship',
      title: 'See who guides the chapter and how leadership supports its mission.',
      intro: 'The Board of Directors page is designed to make chapter leadership visible, understandable, and equally represented once NEVShe supplies approved information.',
      sections: [
        ['Why the board belongs on the public site', 'Members, prospective members, partners, and the wider healthcare facilities community should be able to see who is responsible for guiding NEVShe. A clear leadership page creates accountability and gives the organization a human face. It explains the roles represented on the board and provides a consistent place for approved names, employers, professional titles, biographies, headshots, and committee assignments when available. Every leader receives the same visual weight; office order communicates responsibility without turning the directory into a ranking of personal importance.'],
        ['Leadership connected to chapter priorities', 'The board helps keep NEVShe focused on its mission of targeted education, professional development, and networking. Public leadership information can help visitors understand the range of professional experience contributing to chapter decisions and the statewide perspective behind programs. The page can also show how officers and directors support education, events, membership, sponsorship, resources, and chapter operations without inventing responsibilities that have not been confirmed. When biographies are supplied, they should emphasize relevant experience and service rather than read like unrelated résumés.'],
        ['A maintainable and respectful directory', 'Approved headshots will replace the neutral portrait placeholders, and every photo will use the same crop, scale, and card treatment. If a headshot is not available, the consistent portrait fallback avoids numbering people or implying that one person is more valuable than another. Structured WordPress fields will let an authorized editor update a name, role, employer, biography, photo, and display order without redesigning the layout. This keeps leadership information current and makes future board transitions easier to manage while protecting the overall visual structure.'],
        ['How visitors can continue from leadership', 'Someone viewing the board may want to understand the chapter before joining, ask a leadership-related question, or see the programs the organization supports. The page therefore connects naturally to About NEVShe, Membership, Events, Education, and Contact instead of ending with a list of names. Once approved biographies are available, individual entries can provide enough context to establish experience and service while keeping the public page concise. Longer individual profile pages are optional and should be added only if NEVShe has enough approved content to make them useful.']
      ]
    },
    'events': {
      eyebrow: 'Plan, participate, and follow up',
      title: 'An event page should answer more than when and where.',
      intro: 'The Events page gives visitors one reliable place to understand upcoming programs, register through the correct destination, and return for approved materials afterward.',
      sections: [
        ['Help visitors decide before they register', 'A useful event listing should make the decision process clear. When NEVShe confirms a program, the page can show its title, category, date, time, time zone, format, venue, registration destination, speakers, learning objectives, and continuing-education information. Pricing, agenda files, maps, and sponsor recognition can appear when they apply and have been approved. Presenting those details consistently helps visitors understand whether an event matches their interests, schedule, location, and professional goals before they leave the site to register.'],
        ['Support learning and connection during the program', 'NEVShe events can bring together facility managers, engineers, technicians, healthcare leaders, and industry partners around shared professional interests. The page prepares people for that experience by collecting the information they need in one place. In-person, virtual, and hybrid programs can use the same structured event system while displaying the details appropriate to each format. Clear descriptions and objectives keep the focus on why the program matters, while speaker and location information helps attendees arrive prepared and understand who is contributing.'],
        ['Keep useful material available after the event', 'The value of a program does not need to disappear when the date passes. A past-event archive can retain an approved recap, presentation files, recordings, photographs, related resources, and sponsor acknowledgments when NEVShe chooses to publish them. Visitors can search previous programs by category or topic and continue learning from material that remains relevant. This also creates a visible record of chapter activity and gives prospective members or partners a better understanding of the education and professional connection NEVShe provides.'],
        ['A system chapter staff can maintain', 'Each event will be entered through structured WordPress fields rather than a custom page layout. An authorized editor can add the confirmed program details, imagery, documents, registration destination, and post-event material once, and the featured section, archive card, filters, and event detail page will update from that record. This reduces repeated work and helps information remain consistent across the site. Event-specific registration links will stay attached to the correct program rather than being treated as permanent global destinations.']
      ]
    },
    'education': {
      eyebrow: 'Learning with a purpose',
      title: 'Connect professional development to real healthcare facility work.',
      intro: 'The Education page organizes upcoming learning and lasting resources so visitors can choose the format and subject that fit their needs.',
      sections: [
        ['Targeted learning for complex environments', 'Healthcare facilities bring together life safety, utilities, water, energy, construction, maintenance, emergency readiness, compliance, technology, leadership, and many other responsibilities. NEVShe’s educational purpose is to help professionals strengthen knowledge connected to that work. The page explains the role of chapter education without promising unconfirmed courses or credentials. As programs are approved, visitors will be able to see what each opportunity covers, who it is for, how it is delivered, and what information is available about learning objectives or continuing-education credit.'],
        ['Two clear ways to keep learning', 'Some visitors need an upcoming session where they can learn and connect with others. Those opportunities belong in the Events system, where dates, speakers, locations, registration links, and program details can be kept current. Other visitors need material they can use between programs. Approved presentations, technical references, certification links, recordings, and trusted external guidance belong in the Resources library. The Education page connects those two paths so people do not have to guess whether a learning item is an event or a reference.'],
        ['Designed to grow without becoming overwhelming', 'NEVShe can add learning opportunities over time without turning this page into a crowded list of invented topics. Structured categories and related-resource links can organize confirmed material as it becomes available. A program may connect to supporting references before the event and to approved presentations or recordings afterward. That structure helps visitors continue from awareness to participation and then to practical follow-up. It also gives chapter editors a repeatable way to publish new education without rebuilding the page for every session.'],
        ['What belongs here and what does not', 'This page should explain NEVShe’s educational role and guide visitors to confirmed learning opportunities. It should not display six empty topic categories merely to make the page look full, and it should not claim that a program offers credit until that information is approved. New categories earn a place when real events or resources support them. That approach keeps the education experience focused, credible, and easier to navigate while giving the chapter room to expand as its programming develops.']
      ]
    },
    'membership': {
      eyebrow: 'Understand the value before joining',
      title: 'Membership begins with clarity about community and participation.',
      intro: 'This page explains who NEVShe brings together, how membership supports professional connection, and where the existing registration process begins.',
      sections: [
        ['Who the membership community serves', 'NEVShe is built around healthcare facility managers, engineers, technicians, healthcare leaders, and industry partners whose work supports healthcare environments across Nevada. The membership page helps prospective members recognize whether this professional community is relevant to them. It describes the shared focus on education, professional development, networking, and stronger healthcare facilities without inventing membership categories or eligibility rules. Final types, prices, renewal terms, and included benefits will appear only after NEVShe confirms them.'],
        ['What participation can make easier', 'Membership creates an ongoing connection to the chapter rather than a single visit to an event or resource. Members can stay aware of education, chapter activity, professional relationships, and opportunities to contribute experience. The page connects that purpose to the rest of the site so visitors can review events, education, resources, leadership, and the public organization directory before deciding to register. This gives people a useful picture of the community while keeping all financial and benefit claims tied to information NEVShe has approved.'],
        ['A clear registration and administration path', 'When a visitor is ready, the Join NEVShe action opens the existing Constant Contact registration and payment workflow. The donated first phase does not create a new membership-management system, automatic account, or private individual directory. NEVShe will continue processing membership information through its current administrative process. The page should explain that handoff clearly, answer common questions with confirmed information, and provide a contact route for anything that needs clarification before registration.'],
        ['Information NEVShe still needs to confirm', 'Before final content approval, the chapter should provide the official membership types, eligibility rules, current pricing, payment and renewal terms, exact benefits, and frequently asked questions. Those facts will replace broad placeholders without changing the approved page structure. The copy can then help visitors compare options and understand what happens after registration. Keeping that information in a structured, reviewable section prevents unconfirmed details from being presented as promises and gives future editors one reliable place to update membership terms.']
      ]
    },
    'member-directory': {
      eyebrow: 'A useful public organization directory',
      title: 'Help visitors discover member organizations without exposing private details.',
      intro: 'The Member Directory is organization-based, searchable, and designed around approved public information rather than individual profiles.',
      sections: [
        ['What visitors will be able to find', 'The directory helps visitors discover organizations connected to Nevada’s healthcare facilities community. Each listing can include an approved organization name, industry or service category, logo, public website, and concise description. Filters can narrow the list by category, and an accordion keeps the page easy to scan while allowing visitors to open more information only when they want it. The directory is not intended to display a member’s complete personal profile or reproduce private membership records.'],
        ['Privacy is part of the design', 'Phase One excludes personal email addresses, direct phone numbers, private profiles, login credentials, and protected member information. Visitors who want to connect with an organization can use its approved public website or a general contact route. This boundary keeps the directory useful without creating an unnecessary privacy or account-management burden. It also makes the page easier for NEVShe to maintain because the published information remains limited to low-risk organization-level fields that have been reviewed for public display.'],
        ['Logos and information need an intake process', 'Current member organizations should provide an approved SVG or transparent PNG logo, a website link, an industry category, a short public description, and permission for NEVShe to display those materials. New-member registration should collect the same information so future listings can be added consistently. If an approved logo is unavailable, the neutral organization symbol remains in place; numbers will not be used. Authorized staff can update each record through simple WordPress fields, and the directory layout will update automatically.'],
        ['Why the accordion approach fits Phase One', 'An accordion lets many organizations share one page without forcing visitors through a large grid of incomplete profiles. The closed view shows the logo, name, and category; opening a listing reveals the approved summary and website information. This works whether the directory begins with a few entries or grows substantially. It also avoids building individual profile pages before NEVShe has enough public material to support them. A future protected member directory would be a separate project with different privacy, access, and administration requirements.']
      ]
    },
    'sponsorship': {
      eyebrow: 'Support with context',
      title: 'Explain why sponsorship matters before presenting an opportunity.',
      intro: 'The Sponsorship page connects organizational support to NEVShe’s mission, audiences, and statewide professional community without inventing benefits or pricing.',
      sections: [
        ['Why organizations may choose to support NEVShe', 'Companies that serve healthcare facilities often contribute specialized knowledge, products, services, and professional perspective. Sponsorship gives those organizations a way to support the chapter’s education, professional development, networking, and statewide connection. The page explains that relationship in practical terms so a prospective sponsor can understand the community before entering a registration process. It does not promise exposure, access, exclusivity, or outcomes that NEVShe has not formally approved.'],
        ['Recognition should be useful and respectful', 'Approved sponsor recognition can appear in the sponsor directory, selected event records, and appropriate sitewide areas. Each use should connect a logo and organization name to clear public information rather than treating sponsors as decoration. Consistent presentation recognizes different levels without making other supporters appear unimportant. Final level names, availability, terms, pricing, benefits, event-specific options, and any founding-partner designation remain client-controlled facts and will be published only after confirmation.'],
        ['A straightforward path from interest to registration', 'Prospective sponsors can review the chapter’s purpose, audiences, recognition approach, and frequently asked questions before choosing Become a Sponsor. That action continues to NEVShe’s existing Constant Contact and payment workflow. The page also provides a question route for organizations that need clarification first. Approved sponsor intake should collect the company name, level, logo, website, short public description, and display permission so the same information can populate the directory and other recognition areas consistently.'],
        ['Information needed before final approval', 'NEVShe should confirm the sponsorship level names, prices, duration, availability, exact benefits, event-specific opportunities, renewal terms, and any founding or featured designation. The chapter should also confirm how logos may appear across the site and who approves sponsor descriptions. Once supplied, those facts can replace the current guarded language while the visual structure remains stable. This lets Blue Nova write clear final copy without turning assumptions into commitments that sponsors may rely on.']
      ]
    },
    'sponsor-directory': {
      eyebrow: 'Recognition visitors can understand',
      title: 'Show who supports the chapter and how each organization connects.',
      intro: 'The Sponsor Directory turns approved recognition into an informative, organized resource for the NEVShe community.',
      sections: [
        ['More than a wall of logos', 'A sponsor logo is more meaningful when visitors can identify the organization and understand what it does. Each directory listing can pair an approved logo with the company name, confirmed sponsorship level, public website, and concise description. Visitors can browse or filter organizations without seeing unconfirmed claims. This approach gives sponsors clear recognition while helping facility professionals learn which organizations provide services, expertise, products, or other support relevant to healthcare environments.'],
        ['Levels without an implied personal ranking', 'Sponsors may be grouped by NEVShe’s confirmed levels or featured status, but every listing should remain legible and professionally presented. Larger placement can communicate an approved sponsorship distinction without diminishing the organizations shown in other groups. Until NEVShe supplies the final level names, benefits, display order, and current roster, the mockup uses neutral placeholders. No organization will be assigned a level or described as a founding partner without authoritative client information.'],
        ['One record can support consistent recognition', 'The production site can manage sponsors through structured WordPress fields. An authorized editor enters the company name, logo, website, level, description, status, and display order once. The approved record can then populate this directory, relevant event recognition, and the sitewide sponsor display without repeated manual layout work. That system makes updates simpler and reduces inconsistencies. New sponsors should provide approved logo files and public-display permission as part of intake so recognition can begin with complete, usable information.'],
        ['How visitors move beyond the directory', 'Visitors who want to learn more can open the sponsor’s approved public website rather than relying on personal contact details stored by NEVShe. Organizations interested in participating can continue to the Sponsorship page, where the chapter’s purpose, audience, process, and confirmed opportunities are explained. This keeps the directory focused on recognition and discovery. It also prevents the page from becoming a collection of oversized advertisements or incomplete profiles that do not help the facilities community understand who is involved.']
      ]
    },
    'resources': {
      eyebrow: 'Guidance that is easier to trust and use',
      title: 'Organize professional information by source, subject, and format.',
      intro: 'The Resources page is a public library for approved files and trusted external links connected to healthcare facility work and professional development.',
      sections: [
        ['Know what you are opening', 'Every resource should provide enough context for a visitor to make an informed choice before selecting it. A listing can show the title, topic, source, format, publication date, short description, and whether it opens a document or an external website. That structure is especially important for codes, regulatory references, technical guidance, certification information, and time-sensitive material. NEVShe can identify the source clearly without turning a link collection into unverified compliance or professional advice.'],
        ['Browse around real questions and responsibilities', 'Visitors may arrive with different goals: preparing for an emergency, reviewing water-management information, exploring energy and sustainability, finding certification resources, or looking for material connected to a chapter program. Search and filters make those paths manageable as the library grows. Categories should reflect resources NEVShe has actually approved rather than creating empty topic pages. Related links can also connect a resource to an event, education item, news story, or chapter announcement when that relationship is useful.'],
        ['A library that stays current', 'Resources lose value when ownership, dates, formats, or destinations are unclear. Structured WordPress fields will allow authorized editors to add a source, link or file, description, topic, publication information, and featured image without changing the archive layout. NEVShe can review older items, replace superseded files, and remove broken or outdated destinations as part of ongoing content maintenance. This creates a professional library that is easier to search, easier to update, and more transparent about where information comes from.'],
        ['Editorial responsibility remains visible', 'NEVShe decides which files and external sources belong in the library and when an item is no longer appropriate. Chapter-created material, outside guidance, certification information, and regulatory links should be labeled so visitors can distinguish them. Downloads should identify file type and size before opening, and external destinations should be clear. This source-aware presentation supports informed use while avoiding the impression that every linked item was written, controlled, or legally endorsed by the chapter.']
      ]
    },
    'news': {
      eyebrow: 'Stories that show the chapter in motion',
      title: 'Use news to explain activity, people, and professional context.',
      intro: 'The News page creates a searchable record of chapter updates while giving important stories a longer life than a single announcement.',
      sections: [
        ['Keep the community informed', 'Chapter news can communicate organizational milestones, leadership updates, program announcements, calls for participation, and other approved developments. A consistent archive makes those updates easier to find than scattered notices. Each post can include a clear headline, date, category, image, excerpt, and full article, with related links leading visitors to relevant events, resources, membership information, or contact routes. That structure helps returning visitors see what is current and gives first-time visitors evidence of an active professional community.'],
        ['Make room for people and organizations', 'Member and sponsor spotlights can introduce approved perspectives, experience, projects, and contributions without publishing private details or unsupported promotional claims. Event recaps can preserve key themes, photographs, presentations, recordings, and related resources when permission is available. These stories help the site feel human and statewide while showing how professionals and organizations participate in NEVShe. Names, affiliations, quotations, images, and factual claims will be published only after the appropriate source and approval are recorded.'],
        ['Add useful professional context', 'Industry updates, advocacy information, and continuing-education stories can help readers understand why a development matters to healthcare facilities. NEVShe can summarize approved information and link to authoritative sources while distinguishing chapter commentary from external guidance. Categories and search make the archive manageable as it grows, and standard WordPress posts keep publishing familiar for editors. The goal is not to fill a blog calendar with generic content; it is to create timely, credible updates that support the chapter’s mission and connect readers to deeper information.'],
        ['A manageable publishing workflow', 'News will use standard WordPress posts with categories, featured images, excerpts, article content, authorship rules, and SEO fields. That familiar workflow allows routine editors to publish without changing templates or responsive settings. Reusable archive and single-post designs keep typography, sharing options, and related links consistent. An editorial calendar can be added later if NEVShe wants one, but the page does not depend on artificial publishing volume. Quality, accuracy, permission, and relevance remain more important than filling every category immediately.']
      ]
    },
    'contact': {
      eyebrow: 'Choose the right route',
      title: 'Make it easy to ask a question or take a direct action.',
      intro: 'The Contact page separates general inquiries from registration and notification actions so visitors know what will happen next.',
      sections: [
        ['Start with the purpose of the message', 'A focused contact form helps NEVShe understand why someone is reaching out. Visitors can identify a general question, membership concern, sponsorship inquiry, or events and education topic before describing what they need. That simple choice can support accurate routing after NEVShe confirms the appropriate recipients. The form should collect only the information necessary for a response and should explain required fields, validation, privacy consent, errors, and confirmation clearly when it becomes functional on the production site.'],
        ['Use direct destinations when no message is needed', 'Some visitors do not need to wait for a reply. People ready to join or sponsor can continue directly to the existing Constant Contact registration and payment workflow. People who want future event information can use the confirmed notification-list signup. Keeping those actions separate from the general form reduces unnecessary messages and gives visitors a faster path. The Contact page explains the difference so each button has a clear purpose instead of presenting several actions that appear to do the same thing.'],
        ['Set practical expectations and protect information', 'The public page will include a confirmed general email address and approved social links when NEVShe supplies them. It will not promise a response time or publish personal contact details without authorization. Before launch, form routing, spam protection, error handling, confirmation messages, storage, retention, and authenticated email delivery must be tested on staging. The final privacy policy should reflect what the form collects and which outside services support registration or notifications. This keeps the contact experience useful while respecting both visitor information and the chapter’s administrative capacity.'],
        ['What NEVShe must supply before launch', 'The chapter needs to confirm the general contact email, form recipients for each topic, any approved public phone or mailing information, social profile links, and the person responsible for responding. Those decisions affect both the visible page and the technical routing behind it. Once confirmed, the production form can be tested from submission through delivery and response handling. Until then, the mockup demonstrates the experience without pretending the form is active or directing private information to an unverified destination.']
      ]
    }
  };
  ...
  const pageConfigs = {
    ...
    'events': {
      ...
      overviewHeading: ['More than a date on a calendar','Each event should help visitors decide, prepare, and follow through.','The event system is designed to carry useful information before, during, and after a program—not just an announcement.'],
      ...
      archiveHeading: ['Current and upcoming programs','Find the next NEVShe opportunity.','Confirmed event records will replace the examples below. Search and filters will help visitors find learning, networking, chapter meetings, and past-event materials.'],
    ...
    'education': {
      ...
      overview: [['Build usable knowledge','Targeted education','Programs can help professionals understand issues affecting safety, operations, compliance, efficiency, leadership, and resilient healthcare environments.'],['Learn in the right format','Multiple ways to participate','The site will organize live programs, webinars, presentations, external certification links, and future on-demand materials as they are approved.'],['Continue after the session','Resources that remain useful','Approved presentations, references, recordings, and related guidance can be connected to event and resource records for later use.']],
      pathways: [
    ...
    'membership': {
      ...
      audienceHeading: ['Who membership is designed to connect','A professional community with a shared focus.','Final eligibility, membership types, pricing, and included benefits still require NEVShe confirmation, but the intended community is clear.'],
    ...
    'member-directory': {
      ...
      overviewHeading: ['A practical statewide directory','Find organizations by what they do.','The directory is designed to help visitors discover healthcare providers, engineering firms, contractors, facility-service companies, and technology partners connected to NEVShe.'],
    ...
    'sponsor-directory': {
      ...
      overviewHeading: ['Recognition that stays useful','See who supports the chapter and what they do.','The sponsor directory will combine approved logos with concise organization information so recognition also helps visitors understand each sponsor’s connection to healthcare facilities.'],
    ...
    'resources': {
      ...
      overviewHeading: ['A library built for real work','Know what a resource is before opening it.','Every approved item should show its source, topic, format, publication information, and whether it opens a document or a trusted external website.'],
    ...
    'news': {
      ...
      overviewHeading: ['A living record of chapter activity','News should help visitors understand what NEVShe is doing.','The archive can connect timely announcements with lasting stories about programs, people, organizations, and the healthcare facilities profession.'],
      ...
      archiveHeading: ['Planned editorial categories','Choose the kind of update you want to read.','The cards below demonstrate the planned content mix. Published articles will replace them with real headlines, dates, images, excerpts, and related links.'],
  ...
  const linkedCards = (cards) => `<div class="grid grid-3">${cards.map((x,i) => `<article class="card"><div class="card-icon">${['✦','↗','◇'][i%3]}</div><h3>${x[0]}</h3><p>${x[1]}</p>${x[3] ? `<a class="card-link" href="${local(x[3])}">${x[2]} →</a>` : `<span class="card-link">${x[2]} →</span>`}</article>`).join('')}</div>`;
  const visualStory = (c) => `<section class="section visual-story-section"><div class="container"><div class="visual-story"><div class="visual-story-media" style="--story-image:url('${img(c.supportImage)}')"></div><div class="visual-story-copy"><div class="eyebrow" style="color:var(--violet)">${c.storyEyebrow}</div><h2>${c.storyTitle}</h2><p>${c.storyText}</p></div></div></div></section>`;
  ...
  const pagePurposeSection = (c) => {
    const purpose = pagePurpose[id];
    if (!purpose) return '';
    return `<section class="section purpose-copy-section"><div class="container">${sectionHeading(purpose.eyebrow,purpose.title,purpose.intro)}<div class="purpose-copy">${purpose.sections.map(([title,text]) => `<article><h3>${title}</h3><p>${text}</p></article>`).join('')}</div></div></section>`;
  };
  ...
  function renderAbout(c) {
    ...
    return `${pageHero(c)}
      <section class="section section-alt"><div class="container">${sectionHeading('Why the chapter exists','A statewide professional home for healthcare facilities.','NEVShe gives the people responsible for healthcare environments a focused place to learn, build relationships, and strengthen the work that supports patient care.')}<div class="grid grid-3">${c.sections.map((s,i)=>`<article class="card"><div class="card-icon">${['✦','↗','✓'][i]}</div><div class="meta">${['Professional purpose','Statewide connection','Operational impact'][i]}</div><h3>${s[0]}</h3><p>${s[1]}</p></article>`).join('')}</div></div></section>
      ${pagePurposeSection(c)}
      ${c.supportImage ? visualStory(c) : ''}
      ...
      <section class="section"><div class="container">${sectionHeading('Who NEVShe brings together','Different roles. Shared responsibility.','The chapter is designed around the professionals and partners whose decisions, technical work, leadership, and coordination shape healthcare facilities every day.')}${featureCards(audiences)}</div></section>
  ...
  function renderEducation(c) {
    ...
    return `${pageHero(heroConfig)}
      ${cardSection(c.overviewHeading,c.overview)}
      ${pagePurposeSection(c)}
  ...
  function renderDirectory(c) {
    ...
    return `${pageHero(c)}${cardSection(c.overviewHeading,c.overview)}${pagePurposeSection(c)}<section class="section"><div class="container"><div class="search-panel"><input type="search" aria-label="Search directory" placeholder="Search this directory"><button class="btn btn-primary" type="button">Search</button></div>${c.filters ? `<div class="filter-bar" style="margin-top:18px">${c.filters.map((f,i)=>`<button class="filter" type="button" aria-pressed="${i===0}">${f}</button>`).join('')}</div>` : ''}</div></section>
      <section class="section section-alt"><div class="container">${sectionHeading(...(c.directoryHeading || ['Directory','Browse organizations and chapter leadership.','Confirmed names, organizations, roles, and public profile details will appear here.']))}${featureCards(c.cards,id === 'board-of-directors' ? 'people' : true)}</div></section>
      ${c.supportImage ? visualStory(c) : ''}
      ${privacyNote}`;
  }
  ...
  function renderMemberDirectory(c) {
    return `${pageHero(c)}${cardSection(c.overviewHeading,c.overview)}${pagePurposeSection(c)}<section class="section"><div class="container"><div class="search-panel"><input type="search" aria-label="Search member organizations" placeholder="Search member organizations"><button class="btn btn-primary" type="button">Search</button></div>${c.filters ? `<div class="filter-bar" style="margin-top:18px">${c.filters.map((f,i)=>`<button class="filter" type="button" aria-pressed="${i===0}">${f}</button>`).join('')}</div>` : ''}</div></section>
      <section class="section section-alt"><div class="container">${sectionHeading('Member organizations','Browse approved organization profiles.','Select an organization to view its public details. One example is open below to demonstrate the final experience.')}${organizationProfiles(c.cards)}</div></section>
  ...
  function renderArchive(c) {
    return `${pageHero(c)}${cardSection(c.overviewHeading,c.overview)}${pagePurposeSection(c)}<section class="section"><div class="container"><div class="search-panel"><input type="search" aria-label="Search ${c.name}" placeholder="Search ${c.name.toLowerCase()}"><button class="btn btn-primary" type="button">Search</button></div><div class="filter-bar" style="margin-top:18px">${c.filters.map((f,i)=>`<button class="filter" type="button" aria-pressed="${i===0}">${f}</button>`).join('')}</div></div></section>
      <section class="section section-alt" id="library"><div class="container">${sectionHeading(...(c.archiveHeading || [`Browse ${c.name.toLowerCase()}`,'Find the information that matters to you.','Use search and filters to narrow the collection. New items will appear here as they are published.']))}${featureCards(c.cards)}</div></section>
  ...
  function renderConversion(c) {
    return `${pageHero(c)}<section class="section"><div class="container">${sectionHeading('Why participate','Learn, connect, and support the statewide community.','Confirmed eligibility, levels, pricing, benefits, and financial terms will be added when available.')}${featureCards(c.cards)}</div></section>
      ${pagePurposeSection(c)}
      ${c.supportImage ? visualStory(c) : ''}
      ${cardSection(c.audienceHeading,c.audiences,true)}
